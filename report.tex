...
\author{
\IEEEauthorblockN{Hassan Raza (2024229) , this is life just commiting for the sake of it}
\IEEEauthorblockA{
 \\
...
\begin{figure}[H]
\centering
\includegraphics[width=0.98\linewidth]{demo_output.png}
\caption{Processor simulation waveform output showing ALU results, clock, instruction data, register outputs, and data memory operations}
\label{fig:waveform-output}
\end{figure}
